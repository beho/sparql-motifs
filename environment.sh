...
# export CLASSPATH=$LIB_PATH/TDB-0.8.10/lib/*:$LIB_PATH/jgrapht-0.8.2/jgrapht-jdk1.6.jar:$LIB_PATH/akka/lib/scala-library.jar:$LIB_PATH/akka/lib/akka/*:$LIB_PATH/smack/*:.
export CLASSPATH=target/sparql-motifs-0.0.1.jar:$CLASSPATH

# SCALA_HOME=$BASE_PATH/scala 
SCALA_HOME=/opt/local/share/scala-2.9

# AKKA_HOME=$LIB_PATH/akka
